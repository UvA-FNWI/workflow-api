    ...
    ILogger<WorkflowInstanceDtoFactory> logger)
{
        ...
        CancellationToken ct)
    {
        ...
        {
            if (!field.Condition.IsMet(context)) // IsMet(null) returns true, so safe for unset conditions
                continue;
            ...
            result.Add(new FieldDto(key, field.DisplayTitle, obj, field.IsHighlighted ?? false));
        }
