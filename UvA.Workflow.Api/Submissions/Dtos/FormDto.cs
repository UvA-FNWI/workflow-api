    ...
    bool HideInResults)
{
    public static QuestionDto Create(PropertyDefinition propertyDefinition, ObjectContext context) => new(
        ...
        propertyDefinition.Table == null ? null : TableSettingsDto.Create(propertyDefinition.Table, context),
...
{
    public static TableSettingsDto Create(TableSettings tableSettings, ObjectContext context) => new(
        FormDto.Create(tableSettings.Form, context), tableSettings.Layout
    );
}
